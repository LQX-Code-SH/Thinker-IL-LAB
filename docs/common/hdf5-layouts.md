...
> 来源：`ubt_IL/scripts/convert/common/all_robot_h5_info_v1.2.md`。涵盖各来源机型的 HDF5 数据（end_effector / joint_position / 相机 / 深度）维度与单位定义，编写自定义转换配置前请先对照本文。
...
#### Note
> The h5 format is identical to that of the AgileX 3RGB described in `all_robot_h5_info.md`（仓库内 v1.0 版参考）.
...
#### Note
> The h5 format is identical to that of the Franka 3RGB described in `all_robot_h5_info.md`（仓库内 v1.0 版参考）.
...
#### Note
> The h5 format is identical to that of the Simulation Franka described in `all_robot_h5_info.md`（仓库内 v1.0 版参考）.
...
#### Note
> The h5 format is identical to that of the Tien Kung Gello 1RGB described in `all_robot_h5_info.md`（仓库内 v1.0 版参考）.
...
#### Note
> The h5 format is identical to that of the Tien Kung Xsens 1RGB described in `all_robot_h5_info.md`（仓库内 v1.0 版参考）.
...
#### Note
> The h5 format is identical to that of the UR 1RGB described in `all_robot_h5_info.md`（仓库内 v1.0 版参考）.
