...
def main(config: ArgsConfig):
    ...
    state_dim_mismatch = data_max_state_dim != model.config.action_head_cfg['max_state_dim']


    if action_horizon_mismatch or action_dim_mismatch or state_dim_mismatch:
        # Store old values for logging
        old_action_horizon = model.action_head.config.action_horizon
        old_action_dim = model.action_head.config.action_dim
        old_state_sim = model.config.action_head_cfg['max_state_dim']
        model.config.action_head_cfg['max_state_dim'] = data_max_state_dim
        model.config.action_head_cfg['max_action_dim'] = data_max_action_dim
        print(
        ...
        if state_dim_mismatch:
            print(f"Updating max_state_dim {data_max_state_dim} (was {old_state_sim})")
        ...
        new_action_head_config.max_state_dim = data_max_state_dim
